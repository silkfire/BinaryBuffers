...
public class BinaryBufferWriterTests
{
    ...
    public class Constructor
    {
        ...
        {
            public override WriterFixtureByteArray CreateFixtureWithNullUnderlyingByteArray() => new(() => null);

            public override WriterFixtureByteArray CreateFixture() => new();
        }

        public class ByteArrayWithOffsetAndLength : Constructor<WriterFixtureByteArray>
        {
            public override WriterFixtureByteArray CreateFixtureWithNullUnderlyingByteArray() => new(() => null, 1, DefaultDataLength - 1);

            public override WriterFixtureByteArray CreateFixture() => new(1, DefaultDataLength - 1);
