...
public class BinaryBufferReaderTests
{
    ...
    public class Constructor
    {
        ...
        {
            public override ReaderFixtureByteArray CreateFixtureWithNullUnderlyingByteArray() => new(() => null);

            public override ReaderFixtureByteArray CreateFixture() => new();
        }

        public class ByteArrayWithOffsetAndLength : Constructor<ReaderFixtureByteArray>
        {
            public override ReaderFixtureByteArray CreateFixtureWithNullUnderlyingByteArray() => new(() => null, 1, DefaultDataLength - 1);

            public override ReaderFixtureByteArray CreateFixture() => new(1, DefaultDataLength - 1);
        ...
        {
            public override ReaderFixtureArraySegment CreateFixtureWithNullUnderlyingByteArray() => new(new ArraySegment<byte>());

            public override ReaderFixtureArraySegment CreateFixture() => new();
        }
        ...
        public class ArraySegmentWithOffsetAndLength : Constructor<ReaderFixtureArraySegment>
        {
            ...
            public override ReaderFixtureArraySegment CreateFixture() => new(1, DefaultDataLength - 1);
        ...
        where TReaderFixture : ReaderFixture<TReaderFixture>
    {
        ...
        public void Attempting_to_read_a_span_with_a_negative_length_should_return_an_empty_span()
        {
            ...
            Assert.True(actualSpan.SequenceEqual([]));
        }
    }
